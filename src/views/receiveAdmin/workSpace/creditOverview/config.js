...
export const graphicList = [
  { key: 'totalReceivableCount', name: '应收计划总数', value: 0, icon: `${assetsBaseUrl}/receiveAdmin/workSpace/overview-1.png` },
  { key: 'totalReceivableAmount', name: '应收金额总和', value: 0, icon: `${assetsBaseUrl}/receiveAdmin/workSpace/overview-2.png`, isAmount: true },
  { key: 'totalReturnedAmount', name: '已收金额总和', value: 0, icon: `${assetsBaseUrl}/receiveAdmin/workSpace/overview-3.png`, isAmount: true },
]
