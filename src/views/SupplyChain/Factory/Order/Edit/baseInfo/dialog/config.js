...
import { enumToOption } from '@/utils/qjd/supplyChain/tools'
import { vProjectId, vFreightPayId } from '../../util'

export const formConfig = [
  {
    key: 'purchaseType', label: '采购模式', type: 'radio', isHidden: true, disabled: false,
    options: enumToOption(purchaseTypeMode)
  },
  {
    key: 'customerId', label: '客户', type: 'select', isHidden: false, disabled: false,
    filterable: true,
    remote: true,
    remoteMethod: null,
    loading: false,
  ...
  {
    key: 'projectId', label: '项目', type: 'select', isHidden: false, disabled: true,
    filterable: true,
    loading: false,
    options: [],
    valueKey: 'projectId',
  ...
  {
    key: 'addressCode', label: '收货地址', type: 'cascader', isHidden: false, disabled: true,
    options: [],
