<template lang="pug">
  div
    el-checkbox(label='全选' v-model='checkAll' v-if="tableFlag!=='1'" @change="handleSelectAll" :disabled="isEdit ? true : false")
    el-table(:data='tableData' border v-loading="loading")
      ...
      el-table-column(prop='permissionName' label='菜单权限')
        template(slot-scope='{row}')
          el-checkbox(:label='row.permissionName' v-model="row.checkedFlag" :disabled="isEdit?true:false")
