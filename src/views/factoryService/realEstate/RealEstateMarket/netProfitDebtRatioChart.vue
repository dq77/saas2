<template lang="pug">
Chart(title='净利润&负债率TOP5' category='netProfitDebtRatio' :mode='mode' :formData='formData' @changeType='changeType' :loading='netProfitLoading || debtRatioLoading' :options='chartOptions'  :dataSource='dataSource')
</template>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const changeType = async () => {
      ...
      const { netProfitDebtRatioTime: time, netProfitDebtRatio: type } = state.formData
