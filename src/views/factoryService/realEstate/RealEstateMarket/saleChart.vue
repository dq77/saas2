<template lang="pug">
Chart(title='销售TOP5' category='sale' :mode='mode' :formData='formData' @changeType='changeType' :loading='salesVolumeLoading || salesAreaLoading' :options='chartOptions' :dataSource='dataSource')
</template>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const changeType = async () => {
      ...
      const { saleTime: time, sale: type } = state.formData
