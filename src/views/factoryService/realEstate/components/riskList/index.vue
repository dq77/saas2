...
.p-tabs
  ...
  .system-content
    ...
    //- 新闻舆情模块
    NewsPublicOpinion(:companyName='companyName' v-if='currentTab === "newsPublicOpinion"' :type='newsType')
</template>
<script>
...
import { riskConfigTabs, tableColumns, riskRequest } from './config'
...
export default {
  ...
  setup(props) {
    ...
    const realestate = ajaxStore.factoryService.realEstate
