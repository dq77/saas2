...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.dialog.id === 1) {
        this.form.nameFrom = this.dialog.matchCompany
      } else {
        this.form.nameTo = this.dialog.matchCompany
      }
    }
  },
  mounted() {
    this.form.nameFrom = this.actualCompanyName || this.companyName || ''
