...
export const cFormConfig = [
  { type: 'input', key: 'name', label: '实控人姓名', span: 12 },
  { type: 'input', key: 'idCardNo', label: '实控人证件号', span: 12 },
  { type: 'input', key: 'contactPhone', label: '实控人联系号码', span: 12 },
...
export const formRules = {
  name: [
    { required: true, message: '请输入实控人姓名', trigger: 'blur' }
  ],
  idCardNo: [
