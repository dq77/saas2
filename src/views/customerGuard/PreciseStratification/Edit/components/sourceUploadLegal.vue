...
.p-main
  template(v-if='!isSpouse')
    ...
    NormalUpload(title='法人征信报告：' :info='uploadObj.reportInfo' ref='reportRef' :uploadParam='recordParam')
    NormalUpload(title='法人信息授权协议：' :status='true' :info='uploadObj.dealInfo' ref='dealRef' :uploadParam='dealParam')
  template(v-else)
